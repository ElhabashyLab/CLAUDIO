...
class TestM3(unittest.TestCase):
    ...
    def test_compute_interaction_overlap(self):
        self.assertEqual(compute_interaction_ovl(pd.Series(data={"unip_id_a": "X12345", "unip_id_b": "X12345", "pep_copies_found": False, "pos_a":"2", "pos_b":"2"}),2), 1.0)
        self.assertTrue(np.isnan(compute_interaction_ovl(pd.Series(data={"unip_id_a": "X12345", "unip_id_b": "X12344", "pep_copies_found": False, "pos_a":"2", "pos_b":"2"}),2)))
        self.assertTrue(np.isnan(compute_interaction_ovl(pd.Series(data={"unip_id_a": "X12345", "unip_id_b": "X12345", "pep_copies_found": True, "pos_a":"2", "pos_b":"2"}),2)))
